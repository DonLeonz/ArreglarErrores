// Sistema de Novedades (sin autenticación)
class NovedadesSystem {
  constructor() {
    this.news =
      JSON.parse(localStorage.getItem("news")) || this.getInitialNews();
  ...
  getInitialNews() {
    return [
      ...
      {
        id: 4,
        title: "Envases Biodegradables: El Futuro del Empaque Sostenible",
        author: "Usuario Invitado",
        imageUrl: "assets/img/blog/blogDefault.jpg",
        avatarUrl: "assets/img/avatars/default.jpg",
        excerpt:
          "Conoce las alternativas ecológicas en envases que están revolucionando la industria del empaque.",
      },
      {
        id: 5,
        title: "Cómo Esterilizar Envases de Vidrio en Casa",
        author: "Usuario Invitado",
        imageUrl: "assets/img/blog/blogDefault.jpg",
        avatarUrl: "assets/img/avatars/default.jpg",
        excerpt:
          "Métodos efectivos y seguros para esterilizar tus envases de vidrio antes de usarlos para conservas o almacenamiento.",
      },
    ];
  }
        ...
        (article) => `
            <div>
                <div class="uk-card uk-card-default uk-card-hover blog-container-round color-text-black">
                    <div class="uk-card-media-top blog-image-container">
                        <button type="button" onclick="novedadesSystem.showImageModal(${
                          article.id
                        })"
          ...
          article.author
                        ...
                        <button class="uk-button uk-button-secondary uk-margin-small-top uk-border-rounded"
                            ...
                            ${
                              this.visibleComments[article.id]
                                ? "Cerrar comentarios"
                                : "Ver comentarios"
                            }
                        </button>
                        ...
                        ${
                          this.visibleComments[article.id]
                            ? this.renderCommentsSection(article.id)
                            : ""
                        }
                    </div>
                </div>
